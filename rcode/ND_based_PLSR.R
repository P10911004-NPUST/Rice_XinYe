...
loading_ <- plsr_mod$loading.weights[1:ncol(plsr_data)-1, 1:ncol(plsr_data)-1]

write.csv(PVE, row.names = F,
          file = paste(save_figure_path, "ND_PLSR_PVE.csv", sep = "/"))
...
ggsave(filename = paste0("ND_based_PLSR_", crop_season_year, ".", plot_device),            
