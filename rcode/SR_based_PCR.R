...
write.csv(PVE, row.names = F,
          file = paste(save_figure_path, "SR_PCR_PVE.csv", sep = "/"))
...
equation_x = xmin + (xinterval * 0.75)
equation_y = ymax - (yinterval / 4)
...
ggsave(filename = paste0("SR_based_PCR_", crop_season_year, ".", plot_device),            
